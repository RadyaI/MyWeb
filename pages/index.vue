            ...
            <div class="text-bg">
                ...
                <div class="bg-2">
                    <img :src="state.img.homeDefault" :class="{ 'img-bounce': state.img.bounceImgDefault }" alt=""
                        @mouseover="handleMouseOver(), play()" @mouseleave="handleMouseLeave(), stop()">
                    <div class="dialog">
                        <p>Halo perkenalkan aku muhammad radya iftikhar</p>
                    </div>
                </div>
                <div class="bg-3"></div>
            </div>
...
import homeDefaultImg from '../assets/img/homeBingung.png'
